...
def initialize_recipies():
    recipies = []

    recipies.append({"name": "Fruit salad", "ingredients": ["Apple", "Kiwi", "Strawberry"]})
    recipies.append({"name": "Apple Smoothie", "ingredients": ["Apple"]})
    ...
    recipies.append({"name": "Fruit Kebabs", "ingredients": [ "Strawberry", "Cherry", "Kiwi"], "URL": "https://www.chabad.org/recipes/recipe_cdo/aid/2832751/jewish/Fruit-Kebabs.htm"})
